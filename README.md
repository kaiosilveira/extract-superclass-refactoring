...
- Update the repo's homepage on GitHub with:
  ...
  - The following labels: javascript, refactoring, extract-superclass-refactoring
...
```bash
yarn tools:cli generate-cmt-table -r extract-superclass-refactoring
```
...
| Commit SHA                                                                  | Message                  |
| --------------------------------------------------------------------------- | ------------------------ |
| [cmt-sha-1](https://github.com/kaiosilveira/extract-superclass-refactoring/commit-SHA-1) | description of commit #1 |
| [cmt-sha-2](https://github.com/kaiosilveira/extract-superclass-refactoring/commit-SHA-2) | description of commit #2 |
| [cmt-sha-n](https://github.com/kaiosilveira/extract-superclass-refactoring/commit-SHA-n) | description of commit #n |
